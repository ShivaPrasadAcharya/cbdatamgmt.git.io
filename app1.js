...
class DataApp {
    constructor() {
        this.currentDataset = 'data7palo2';
        this.originalData = {};
        this.filteredData = {};
        this.headers = {};
        this.datasetInfo = {};
    ...
    loadData() {
        const datasets = ['data7palo2','data2Images', 'data3Links', 'data4Status', 'data5Url1', 'data5Url2','data5Url3', 'data1Trainees', 'data7palo1','data6IMAGESS'];
